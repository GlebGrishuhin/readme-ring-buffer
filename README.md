...
в процессе расчета. Такой подход избыточен – в момент времени `t_{k}` для расчета слоя нужен лишь слой, соответствующий моменту `t_{k-1}` 
...
[1]: images/ring_buffer_schema.png "Схема, поясняющая идею циклического сдвига индекс текущего слоя в буфере"
